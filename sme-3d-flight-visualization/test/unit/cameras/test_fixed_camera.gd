...
#|------------------------------------------------------------------------------------
#|
#|	File Name	:test_fixed_camera.gd
#|
#|	Target 		:GD script
#|
#|	Description	: Unit testing related to the functions in fixed_camera.gd.
#|
#|	Notes		: 
#|
#|	POC			: Clayton Lewis
...
const FixedCameraScript = preload("res://scripts/Managers/camera_manager/fixed_camera.gd")
